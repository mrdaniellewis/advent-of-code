...
# Not my solution, but actually the correct solution!
...
10_000.times do
  $monkeys.each do |monkey|
    loop do
      ...
      # We only care about numbers divisible by the primes
      # So we can truncate to the highest number divisible by all the primes
      worry %= $ring
